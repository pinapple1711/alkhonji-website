...
export interface Division3DCardProps {
  title: string;
  subtitle: string;
  imageUrl: string;
  actionText: string;
...
export const Division3DCard = React.forwardRef<
  HTMLDivElement,
  Division3DCardProps
>(
  (
    { title, subtitle, imageUrl, actionText, href, className },
    ref
  ) => {
    ...
    return (
      <a href={href} className="block cursor-pointer">
        <motion.div
          ...
          className={cn(
            "relative h-[26rem] w-80 shrink-0 rounded-2xl bg-transparent shadow-2xl border border-[#E7E5E4]/30",
            className
          )}
        >
          <div
          ...
          >
            ...
            <div className="absolute inset-0 h-full w-full rounded-xl bg-gradient-to-b from-[#0F172A]/20 via-transparent to-[#0F172A]/70" />
            ...
            <div className="relative flex flex-col justify-between rounded-xl p-4 text-white">
              ...
              <motion.div
                ...
                className={cn(
                  ...
                  "bg-white/10 backdrop-blur-md ring-1 ring-inset ring-white/20 hover:bg-[#C2410C]/80"
                )}
              >
                {actionText}
              </motion.div>
...
Division3DCard.displayName = "Division3DCard";
