...
import { ArrowRight, Banknote, Heart, GraduationCap, Calendar, Stethoscope, Briefcase, Inbox } from "lucide-react";

const benefits = [
  { icon: Banknote, title: "Competitive Salary", description: "Market-leading compensation reviewed annually against Oman benchmarks." },
  { icon: Heart, title: "Health Insurance", description: "Comprehensive medical, dental, and vision coverage for you and dependents." },
  { icon: GraduationCap, title: "Training Budget", description: "Annual OMR 500 professional development allowance per employee." },
  { icon: Calendar, title: "Generous Leave", description: "30 days annual leave plus public holidays and 10 days sick leave." },
  { icon: Stethoscope, title: "Safety First", description: "Free PPE, annual health screenings, and mental wellness programs." },
  { icon: Briefcase, title: "Career Growth", description: "Clear promotion pathways and internal mobility across all five divisions." },
];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {benefits.map((b, i) => (
                ...
                >
                  ...
                  <p className="text-sm text-[#78716C] leading-relaxed">{b.description}</p>
                </motion.div>
              ))}
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            >
              <div className="mx-auto max-w-lg">
                ...
                <h3 className="text-xl font-semibold text-[#0F172A] mb-3">No Open Positions at This Time</h3>
              ...
              >
                ...
                <ul className="space-y-3 mb-8">
                  {culturePoints.map((point) => (
                    <li key={point} className="flex items-start gap-3 text-[#E7E5E4]">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#C2410C] shrink-0" />
                      {point}
                    </li>
                  ))}
                </ul>
